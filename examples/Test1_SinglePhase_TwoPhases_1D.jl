...
function main()
    ...
    # p1 = plot!(CaseA_0D_std.γxy, CaseA_0D_std.app_fric, label="0D", linestyle=:dashdot, color=:blue)
    # p1 = plot!(CaseA_1D_std.γxy, CaseA_1D_std.app_fric, label="1D", linestyle=:dashdot, color=:green)    
    ...
    p1 = plot!(CaseB_0D_std.γxy, CaseB_0D_std.app_fric, linestyle=:dashdot, color=:blue)
    p1 = plot!(CaseB_1D_std.γxy, CaseB_1D_std.app_fric, linestyle=:dashdot, color=:green)
    ...
    # p2 = plot!(CaseA_0D_std.γxy,  CaseA_0D_std.σxx, label="0D K, G", linestyle=:dashdot, color=:blue)
    # p2 = plot!(CaseA_1D_std.γxy,  CaseA_1D_std.σxx, label="1D K, G", linestyle=:dashdot, color=:green)
    ...
    p2 = plot!(CaseB_0D_std.γxy,  CaseB_0D_std.σxx, label=:none, linestyle=:dashdot, color=:blue)
    p2 = plot!(CaseB_1D_std.γxy,  CaseB_1D_std.σxx, label=:none, linestyle=:dashdot, color=:green)
    ...
    # p3 = plot!(CaseA_0D_std.γxy, CaseA_0D_std.εyy, label="0D", linestyle=:dashdot, color=:blue)
    # p3 = plot!(CaseA_1D_std.γxy, CaseA_1D_std.εyy, label="1D", linestyle=:dashdot, color=:green)
    ...
    p3 = plot!(CaseB_0D_std.γxy, CaseB_0D_std.εyy, linestyle=:dashdot, color=:blue)
    p3 = plot!(CaseB_1D_std.γxy, CaseB_1D_std.εyy, linestyle=:dashdot, color=:green)
    ...
    # p4 = plot!(CaseA_0D_std.γxy, CaseA_0D_std.θ, label="0D", linestyle=:dashdot, color=:blue)
    # p4 = plot!(CaseA_1D_std.γxy, CaseA_1D_std.θ, label="1D", linestyle=:dashdot, color=:green)
    ...
    p4 = plot!(CaseB_0D_std.γxy, CaseB_0D_std.θ, linestyle=:dashdot, color=:blue)
    p4 = plot!(CaseB_1D_std.γxy, CaseB_1D_std.θ, linestyle=:dashdot, color=:green)
