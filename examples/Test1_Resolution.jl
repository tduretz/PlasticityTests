...
function main()
    ...
    CaseB_1D_00 = Main_VEP_1D_vdev(σi; params, visu=false, Ncy=5)
    ...
    CaseB_1D_10 = Main_VEP_1D_vdev(σi; params, visu=false, Ncy=10)
    ...
    CaseB_1D_20 = Main_VEP_1D_vdev(σi; params, visu=false, Ncy=20)
    ...
    p3 = plot!(CaseB_0D_00.γxy, CaseB_0D_00.εyy, color=:blue, label="Nc = 5")
    p3 = plot!(CaseB_1D_00.γxy, CaseB_1D_00.εyy, color=:blue, label=:none, linestyle=:dashdot)
    p3 = plot!(CaseB_0D_10.γxy, CaseB_0D_10.εyy, color=:green, label="Nc = 10")
    p3 = plot!(CaseB_1D_10.γxy, CaseB_1D_10.εyy, color=:green, label=:none, linestyle=:dashdot)
    p3 = plot!(CaseB_0D_20.γxy, CaseB_0D_20.εyy, color=:orange, label="Nc = 20")
