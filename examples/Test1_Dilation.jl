...
function main()
    ...
    p3 = plot!(CaseB_0D_00.γxy, CaseB_0D_00.εyy, color=:blue, label="ψ = 0ᵒ")
    p3 = plot!(CaseB_1D_00.γxy, CaseB_1D_00.εyy, color=:blue, label=:none, linestyle=:dashdot)
    p3 = plot!(CaseB_0D_10.γxy, CaseB_0D_10.εyy, color=:green, label="ψ = 10ᵒ")
    p3 = plot!(CaseB_1D_10.γxy, CaseB_1D_10.εyy, color=:green, label=:none, linestyle=:dashdot)
    p3 = plot!(CaseB_0D_20.γxy, CaseB_0D_20.εyy, color=:orange, label="ψ = 20ᵒ")
