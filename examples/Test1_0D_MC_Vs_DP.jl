...
function main()
    ...
    p1 = plot!(CaseA_0D.γxy, CaseB_0D_DP0.app_fric, label="B: 0D DP0", color=:green, linestyle=:dash)
    ...
    p2 = plot!(CaseA_0D.γxy, CaseB_0D_DP0.σxx, label="B: 0D DP0", color=:green, linestyle=:dash)
    ...
    p3 = plot!(CaseA_0D.γxy, CaseB_0D_DP0.εyy, label="B: 0D DP0", color=:green, linestyle=:dash)
    ...
    p4 = plot!(CaseA_0D.γxy, CaseB_0D_DP0.θ, label="B: 0D DP0", color=:green, linestyle=:dash)
