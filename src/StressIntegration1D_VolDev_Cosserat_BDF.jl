...
function Main_VEP_1D_vdev_coss_BDF(σi; params=(
    #---------------#
    ...
    # Step 0 angles and stress
    PrincipalStress!(σ1, σ3, τxx, τyy, τzz, τxy, Pt)
    probes.θs3_out[1]  = atand(σ3.z[1] ./ σ3.x[1])
    probes.θs3_in[1]   = atand(σ3.z[1] ./ σ3.x[1])
    probes.σxx_out[1]  = σxxi*sc.σ
    probes.σxx_in[1]   = σxxi*sc.σ
